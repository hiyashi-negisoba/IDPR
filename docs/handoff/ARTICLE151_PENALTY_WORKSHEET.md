...
| `derived_offense.fraud` | 사기죄 | 제347조 | 10년 이하 징역 또는 2천만원 이하 벌금 | fine_or_greater |
...
**※3 자격정지 병과형** — 제122조·제127조·제129조·제130조는 선택형에 자격정지가 있고 벌금이
...
> **검수 ㉱** 위 63행을 일괄 승인하는가? 특정 행만 다르게 보시면 그 행에 `> comment:`를
> 달아 주시면 그것만 반영한다.
