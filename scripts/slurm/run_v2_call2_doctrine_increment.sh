...
# Call 2 increment for the cases whose plan gained raised-doctrine leaf targets.
...
#     scripts/slurm/run_v2_call2_doctrine_increment.sh --execution-approved
...
echo "=== Call 2 doctrine increment via service ${SERVICE_JOB_ID} ==="
