#!/bin/bash
#SBATCH --job-name=idpr_call2_smoke
#SBATCH --output=logs/idpr_call2_smoke_%j.out
#SBATCH --error=logs/idpr_call2_smoke_%j.err
...
RUN_DIR="$PROJECT_ROOT/.cache/call2_smoke/${SLURM_JOB_ID}"
OUT="$PROJECT_ROOT/data/eval/card_status_smoke.json"
...
echo "=== IDPR call 2 smoke start: $(date) ==="
...
cleanup
echo "result=$OUT"
echo "=== IDPR call 2 smoke end: $(date) ==="
