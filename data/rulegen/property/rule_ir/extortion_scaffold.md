...
### `not_satisfied_satisfied_art350_sec1_defective_disposition(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄에서는 공갈로 상대방의 하자 있는 의사를 형성하고, 그에 기한 재산적 처분행위를 통하여 재물 또는 재산상 이익을 취득하여야 한다.
...
### `not_satisfied_satisfied_art350_sec1_extortion_definition(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄는 사람을 공갈하여 재물의 교부 또는 재산상 이익의 취득을 얻는 범죄이다.
...
### `not_satisfied_satisfied_art350_sec3_object(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 객체는 타인의 재물 또는 재산상 이익이다.
...
### `not_satisfied_satisfied_art350_sec3_own_property_exception(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 자기의 재물 또는 재산상 이익에 대해서는 공갈죄가 성립하지 않는다.
...
### `not_satisfied_satisfied_art350_sec3_possessed_property_object_affirmative(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 자기가 점유하는 타인 소유의 재물도 공갈죄의 객체가 될 수 있다. 타인을 공갈하여 소유권을 이전하는 처분행위를 하게 할 수 있기 때문이다.
...
### `not_satisfied_satisfied_art350_sec3_real_estate_object(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 부동산도 공갈죄의 객체가 될 수 있다.
...
### `not_satisfied_satisfied_art350_sec4_1_means_threat_or_violence(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈행위에는 협박을 수단으로 하는 경우뿐 아니라 폭행을 수단으로 하는 경우도 포함된다.
...
### `not_satisfied_satisfied_art350_sec4_1_objective_fear_assessment(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈수단이 사람을 외포하게 하기에 족한지는 객관적으로 판단한다.
...
### `not_satisfied_satisfied_art350_sec4_1_objectively_insufficient_threat(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 객관적으로 사람을 외포시키기에 부족한 행위는 상대방이 현실로 외포심을 일으켰더라도 공갈이 아니므로 공갈죄가 성립하지 않고 절도죄가 성립할 여지가 있다.
...
### `not_satisfied_satisfied_art350_sec4_1_robbery_boundary(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 협박이나 폭행이 상대방의 반항을 억압할 정도에 이르면 공갈죄가 아니라 강도죄가 성립한다.
...
### `not_satisfied_satisfied_art350_sec4_2_actual_intent_or_feasibility_not_required(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 행위자가 실제로 해악을 실현할 의사를 가졌는지 또는 해악의 실현이 가능한지는 공갈죄 성립에 영향을 미치지 않는다.
...
### `not_satisfied_satisfied_art350_sec4_2_implied_or_indirect_threat(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 해악의 고지는 명시적일 필요가 없고 언어·거동으로도 가능하며, 피공갈자 외 제3자를 통하여 간접적으로 할 수도 있다.
...
### `not_satisfied_satisfied_art350_sec4_2_right_exercise_exception(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 해악 실현이 위법하지 않더라도 외포시켜 불법으로 재산상 이익을 취득하면 공갈죄가 성립할 수 있으나, 행위가 권리행사인 경우에는 위법성이 조각될 수 있다.
...
### `not_satisfied_satisfied_art350_sec4_2_third_party_harm_notice(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 제3자의 행위에 의한 해악 고지가 공갈이 되려면, 행위자가 제3자의 해악행위 결의에 영향을 미칠 수 있는 입장임을 상대방에게 알게 하거나 상대방이 이를 추측할 수 있어야 한다.
...
### `not_satisfied_satisfied_art350_sec4_2_threat_definition(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 협박은 공포심을 일으킬 목적으로 상대방에게 해악을 통고하는 것이다.
...
### `not_satisfied_satisfied_art350_sec4_2_threat_to_third_party(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 상대방 또는 그 가족·친구 등 제3자에 대한 해악의 통고도 상대방을 외포하게 하기에 족하면 협박에 해당한다.
...
### `not_satisfied_satisfied_art350_sec4_4_separate_victim_disposition_authority(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 피공갈자와 재산상 피해자가 동일인이 아닌 경우, 피공갈자는 공갈 목적 재물 또는 재산상 이익을 처분할 사실상 또는 법률상 권한이나 지위가 있어야 하며, 피공갈자와 재산 처분행위자는 동일하여야 한다.
...
### `not_satisfied_satisfied_art350_sec4_4_victim_capacity(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈의 상대방에는 법인이 포함되며, 공갈의 상대방은 의사능력이 있는 사람에 한정된다.
...
### `not_satisfied_satisfied_art350_sec5_1_threat_fear_disposition_gain(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄 성립에는 협박으로 상대방이 외포하고, 그로 인하여 재산적 처분행위를 하여 행위자 또는 제3자가 재물이나 재산상 이익을 취득하여야 한다.
...
### `not_satisfied_satisfied_art350_sec5_2_fear_causation_required(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄가 성립하려면 협박 또는 폭행과 외포 사이 및 외포와 재산적 처분행위 사이에 인과관계가 있어야 하며, 협박·폭행을 원인으로 하지 않은 외포심에 따른 재산적 처분행위에는 공갈죄가 성립하지 않는다.
...
### `not_satisfied_satisfied_art350_sec5_2_no_fear_attempt(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 협박 또는 폭행을 하였으나 상대방이 외포심을 일으키지 않거나 자선심 등 다른 이유로 재물을 교부한 경우에는 공갈미수죄가 성립한다.
...
### `not_satisfied_satisfied_art350_sec5_2_preexisting_fear_maintained(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 다른 사정으로 이미 외포심을 가진 사람에게 그 외포심을 유지·확실하게 하여 재산적 처분행위를 하게 한 경우에는 공갈죄가 성립한다.
...
### `not_satisfied_satisfied_art350_sec5_3_complete_suppression_robbery(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 협박으로 상대방의 의사가 완전히 억압되어 임의성 있는 재물 교부로 평가할 수 없는 경우에는, 외관상 교부 형식이 있어도 강도죄가 성립한다.
...
### `not_satisfied_satisfied_art350_sec5_3_delivery_tacit_acquiescence(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 상대방이 외포에 따라 묵인하는 동안 공갈자가 직접 재물을 탈취한 경우에도 공갈죄가 성립할 수 있다.
...
### `not_satisfied_satisfied_art350_sec5_3_third_party_receipt_relationship(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 제3자가 재물의 교부 또는 재산상 이익을 받는 경우에도, 피공갈자와 처분행위자가 같은 사람이고 제3자가 공갈자의 사자·대리인 또는 공갈자가 특별히 수익하게 하려는 제3자인 관계가 있으면 공갈죄가 성립할 수 있으며, 그러한 관계가 없으면 공갈죄가 성립하지 않는다.
...
### `not_satisfied_satisfied_art350_sec6_no_overall_property_decrease(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄에서는 피공갈자의 하자 있는 의사에 기한 재물 교부 자체가 재산상 손해에 해당하므로, 피해자 전체 재산의 감소가 반드시 요구되지는 않는다.
...
### `not_satisfied_satisfied_art350_sec6_2_consideration_does_not_negate_extortion(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈로 인해 교부하지 않았을 재물 또는 처분하지 않았을 재산상 이익을 교부·처분하게 된 경우, 상당한 대가를 지급하였더라도 공갈죄가 성립한다.
...
### `not_satisfied_satisfied_art350_sec6_2_satisfied_consideration_causation_exception(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 폭행·협박을 당한 상대방이 객관적으로 상당한 대가에 주관적으로도 만족하여 재물을 교부한 경우에는 해악의 고지와 처분행위 사이의 인과관계가 부정되어 공갈죄 미수가 성립한다.
...
### `not_satisfied_satisfied_art350_sec7_1_attempt_threat_notification(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 재물 또는 재산상 이익을 공여하게 하는 수단으로 사람을 외포시키기에 족한 해악을 고지한 때 공갈죄의 실행에 착수한다.
...
### `not_satisfied_satisfied_art350_sec7_2_completion_fear_disposition_causal_link(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 기수에는 공갈행위, 그로 인한 상대방의 외포, 그리고 그 외포로 인한 재산적 처분행위가 필요하다.
...
### `not_satisfied_satisfied_art350_sec7_3_completion_bank_transfer(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 피해자를 공갈하여 행위자가 지정한 예금계좌에 송금하게 한 경우에는 입금과 동시에 행위자가 자유롭게 처분할 수 있는 상태가 되어 그때 기수에 이른다.
...
### `not_satisfied_satisfied_art350_sec7_3_completion_property_and_benefit(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 재물이 객체인 갈취죄는 재물 교부를 받은 때, 재산상 이익이 객체인 이득죄는 재산상 이익을 취득한 때 기수에 이른다.
...
### `not_satisfied_satisfied_art350_sec8_1_right_enforcement_method_standard(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 정당한 권리를 실현하기 위하여 해악을 고지한 경우에도 그 수단·방법이 사회통념상 허용되는 범위를 넘으면 공갈죄의 실행에 착수한 것이며, 그 판단은 목적과 수단을 전체적으로 종합하여 한다.
...
### `not_satisfied_satisfied_art350_sec8_2_extortion_loss_despite_payment_duty(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 상대방에게 교부·이전 의무가 있더라도 공갈로 인한 외포가 없었다면 교부·이전하지 않았을 재물 또는 재산상 이익을 외포로 교부·이전한 경우, 그 범위에서 재산상 손해가 발생하여 공갈죄의 정형성이 인정된다.
...
### `not_satisfied_satisfied_art350_sec8_2_no_right_extortion(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 재물 또는 재산상 이익을 취득할 권리가 없는 자가 외관상 권리가 있는 것처럼 보이더라도 공갈한 경우에는 권리행사 문제가 아니라 공갈죄가 당연히 성립한다.
...
### `not_satisfied_satisfied_art350_sec8_2_permissible_range_purpose_means(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 권리실현 수단이 사회통념상 허용되는 정도나 범위를 넘는지는 추구 목적과 선택 수단 등 주관적·객관적 측면을 종합하여 판단한다.
...
### `not_satisfied_satisfied_art350_sec8_2_permitted_threat_no_extortion(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 채권 실행 또는 손해배상 합의금 수령 등을 위하여 사회통념상 허용 범위의 위협적 언사를 한 경우 공갈죄가 성립하지 않으며, 수반된 협박행위도 별도의 협박죄를 구성하지 않는다.
...
### `not_satisfied_satisfied_art350_sec8_2_right_exercise_total_assessment(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 권리행사에 수반된 공갈행위의 위법성 조각 여부는 권리행사와 수단행위를 전체적으로 관찰하여, 그 공갈행위가 권리행사의 수단으로 사회통념상 용인될 수 있는지에 따라 판단한다.
...
### `not_satisfied_satisfied_art350_sec8_2_rightful_claim_excessive_method(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 정당한 권리자가 재물 또는 재산상 이익을 취득하더라도, 권리실행의 수단방법이 사회통념상 허용되는 범위를 넘으면 공갈죄 성립이 방해되지 않는다.
...
### `not_satisfied_satisfied_art350_sec9_illicit_gain_intent_required(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄가 성립하려면 고의 외에 불법이득의사가 있어야 한다.
...
### `not_satisfied_satisfied_art350_sec9_intent_objective_elements(case_id: String, defendant_id: String, coerced_person_id: String, disposer_id: String, owner_id: String)`

증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 고의는 모든 객관적 구성요건요소에 대한 인식을 의미하고, 미필적 인식으로도 가능하다.
...
### `extortion.art350_sec1.card.001.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄에서는 공갈로 상대방의 하자 있는 의사를 형성하고, 그에 기한 재산적 처분행위를 통하여 재물 또는 재산상 이익을 취득하여야 한다.**을 도출한다.
...
### `extortion.art350_sec1.card.002.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄는 사람을 공갈하여 재물의 교부 또는 재산상 이익의 취득을 얻는 범죄이다.**을 도출한다.
...
### `extortion.art350_sec3.card.003.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 객체는 타인의 재물 또는 재산상 이익이다.**을 도출한다.
...
### `extortion.art350_sec3.card.004.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 자기의 재물 또는 재산상 이익에 대해서는 공갈죄가 성립하지 않는다.**을 도출한다.
...
### `extortion.art350_sec3.card.005.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 자기가 점유하는 타인 소유의 재물도 공갈죄의 객체가 될 수 있다. 타인을 공갈하여 소유권을 이전하는 처분행위를 하게 할 수 있기 때문이다.**을 도출한다.
...
### `extortion.art350_sec3.card.006.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 부동산도 공갈죄의 객체가 될 수 있다.**을 도출한다.
...
### `extortion.art350_sec4_1.card.007.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈행위에는 협박을 수단으로 하는 경우뿐 아니라 폭행을 수단으로 하는 경우도 포함된다.**을 도출한다.
...
### `extortion.art350_sec4_1.card.008.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈수단이 사람을 외포하게 하기에 족한지는 객관적으로 판단한다.**을 도출한다.
...
### `extortion.art350_sec4_1.card.009.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 객관적으로 사람을 외포시키기에 부족한 행위는 상대방이 현실로 외포심을 일으켰더라도 공갈이 아니므로 공갈죄가 성립하지 않고 절도죄가 성립할 여지가 있다.**을 도출한다.
...
### `extortion.art350_sec4_1.card.010.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 협박이나 폭행이 상대방의 반항을 억압할 정도에 이르면 공갈죄가 아니라 강도죄가 성립한다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.011.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 행위자가 실제로 해악을 실현할 의사를 가졌는지 또는 해악의 실현이 가능한지는 공갈죄 성립에 영향을 미치지 않는다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.012.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 해악의 고지는 명시적일 필요가 없고 언어·거동으로도 가능하며, 피공갈자 외 제3자를 통하여 간접적으로 할 수도 있다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.013.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 해악 실현이 위법하지 않더라도 외포시켜 불법으로 재산상 이익을 취득하면 공갈죄가 성립할 수 있으나, 행위가 권리행사인 경우에는 위법성이 조각될 수 있다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.014.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 제3자의 행위에 의한 해악 고지가 공갈이 되려면, 행위자가 제3자의 해악행위 결의에 영향을 미칠 수 있는 입장임을 상대방에게 알게 하거나 상대방이 이를 추측할 수 있어야 한다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.015.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 협박은 공포심을 일으킬 목적으로 상대방에게 해악을 통고하는 것이다.**을 도출한다.
...
### `extortion.art350_sec4_2.card.016.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 상대방 또는 그 가족·친구 등 제3자에 대한 해악의 통고도 상대방을 외포하게 하기에 족하면 협박에 해당한다.**을 도출한다.
...
### `extortion.art350_sec4_4.card.017.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 피공갈자와 재산상 피해자가 동일인이 아닌 경우, 피공갈자는 공갈 목적 재물 또는 재산상 이익을 처분할 사실상 또는 법률상 권한이나 지위가 있어야 하며, 피공갈자와 재산 처분행위자는 동일하여야 한다.**을 도출한다.
...
### `extortion.art350_sec4_4.card.018.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈의 상대방에는 법인이 포함되며, 공갈의 상대방은 의사능력이 있는 사람에 한정된다.**을 도출한다.
...
### `extortion.art350_sec5_1.card.019.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄 성립에는 협박으로 상대방이 외포하고, 그로 인하여 재산적 처분행위를 하여 행위자 또는 제3자가 재물이나 재산상 이익을 취득하여야 한다.**을 도출한다.
...
### `extortion.art350_sec5_2.card.020.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄가 성립하려면 협박 또는 폭행과 외포 사이 및 외포와 재산적 처분행위 사이에 인과관계가 있어야 하며, 협박·폭행을 원인으로 하지 않은 외포심에 따른 재산적 처분행위에는 공갈죄가 성립하지 않는다.**을 도출한다.
...
### `extortion.art350_sec5_2.card.021.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 협박 또는 폭행을 하였으나 상대방이 외포심을 일으키지 않거나 자선심 등 다른 이유로 재물을 교부한 경우에는 공갈미수죄가 성립한다.**을 도출한다.
...
### `extortion.art350_sec5_2.card.022.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 다른 사정으로 이미 외포심을 가진 사람에게 그 외포심을 유지·확실하게 하여 재산적 처분행위를 하게 한 경우에는 공갈죄가 성립한다.**을 도출한다.
...
### `extortion.art350_sec5_3.card.023.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 협박으로 상대방의 의사가 완전히 억압되어 임의성 있는 재물 교부로 평가할 수 없는 경우에는, 외관상 교부 형식이 있어도 강도죄가 성립한다.**을 도출한다.
...
### `extortion.art350_sec5_3.card.024.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 상대방이 외포에 따라 묵인하는 동안 공갈자가 직접 재물을 탈취한 경우에도 공갈죄가 성립할 수 있다.**을 도출한다.
...
### `extortion.art350_sec5_3.card.025.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 제3자가 재물의 교부 또는 재산상 이익을 받는 경우에도, 피공갈자와 처분행위자가 같은 사람이고 제3자가 공갈자의 사자·대리인 또는 공갈자가 특별히 수익하게 하려는 제3자인 관계가 있으면 공갈죄가 성립할 수 있으며, 그러한 관계가 없으면 공갈죄가 성립하지 않는다.**을 도출한다.
...
### `extortion.art350_sec6.card.026.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄에서는 피공갈자의 하자 있는 의사에 기한 재물 교부 자체가 재산상 손해에 해당하므로, 피해자 전체 재산의 감소가 반드시 요구되지는 않는다.**을 도출한다.
...
### `extortion.art350_sec6_2.card.027.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈로 인해 교부하지 않았을 재물 또는 처분하지 않았을 재산상 이익을 교부·처분하게 된 경우, 상당한 대가를 지급하였더라도 공갈죄가 성립한다.**을 도출한다.
...
### `extortion.art350_sec6_2.card.028.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 폭행·협박을 당한 상대방이 객관적으로 상당한 대가에 주관적으로도 만족하여 재물을 교부한 경우에는 해악의 고지와 처분행위 사이의 인과관계가 부정되어 공갈죄 미수가 성립한다.**을 도출한다.
...
### `extortion.art350_sec7_1.card.029.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 재물 또는 재산상 이익을 공여하게 하는 수단으로 사람을 외포시키기에 족한 해악을 고지한 때 공갈죄의 실행에 착수한다.**을 도출한다.
...
### `extortion.art350_sec7_2.card.030.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 기수에는 공갈행위, 그로 인한 상대방의 외포, 그리고 그 외포로 인한 재산적 처분행위가 필요하다.**을 도출한다.
...
### `extortion.art350_sec7_3.card.031.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 피해자를 공갈하여 행위자가 지정한 예금계좌에 송금하게 한 경우에는 입금과 동시에 행위자가 자유롭게 처분할 수 있는 상태가 되어 그때 기수에 이른다.**을 도출한다.
...
### `extortion.art350_sec7_3.card.032.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 재물이 객체인 갈취죄는 재물 교부를 받은 때, 재산상 이익이 객체인 이득죄는 재산상 이익을 취득한 때 기수에 이른다.**을 도출한다.
...
### `extortion.art350_sec8_1.card.033.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 정당한 권리를 실현하기 위하여 해악을 고지한 경우에도 그 수단·방법이 사회통념상 허용되는 범위를 넘으면 공갈죄의 실행에 착수한 것이며, 그 판단은 목적과 수단을 전체적으로 종합하여 한다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.034.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 상대방에게 교부·이전 의무가 있더라도 공갈로 인한 외포가 없었다면 교부·이전하지 않았을 재물 또는 재산상 이익을 외포로 교부·이전한 경우, 그 범위에서 재산상 손해가 발생하여 공갈죄의 정형성이 인정된다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.035.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 재물 또는 재산상 이익을 취득할 권리가 없는 자가 외관상 권리가 있는 것처럼 보이더라도 공갈한 경우에는 권리행사 문제가 아니라 공갈죄가 당연히 성립한다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.036.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 권리실현 수단이 사회통념상 허용되는 정도나 범위를 넘는지는 추구 목적과 선택 수단 등 주관적·객관적 측면을 종합하여 판단한다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.037.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 채권 실행 또는 손해배상 합의금 수령 등을 위하여 사회통념상 허용 범위의 위협적 언사를 한 경우 공갈죄가 성립하지 않으며, 수반된 협박행위도 별도의 협박죄를 구성하지 않는다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.038.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 권리행사에 수반된 공갈행위의 위법성 조각 여부는 권리행사와 수단행위를 전체적으로 관찰하여, 그 공갈행위가 권리행사의 수단으로 사회통념상 용인될 수 있는지에 따라 판단한다.**을 도출한다.
...
### `extortion.art350_sec8_2.card.039.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 정당한 권리자가 재물 또는 재산상 이익을 취득하더라도, 권리실행의 수단방법이 사회통념상 허용되는 범위를 넘으면 공갈죄 성립이 방해되지 않는다.**을 도출한다.
...
### `extortion.art350_sec9.card.040.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄가 성립하려면 고의 외에 불법이득의사가 있어야 한다.**을 도출한다.
...
### `extortion.art350_sec9.card.041.not_satisfied`

이 규칙은 **증명 가능한 평가에서 다음 조건이 부인됨: 공갈죄의 고의는 모든 객관적 구성요건요소에 대한 인식을 의미하고, 미필적 인식으로도 가능하다.**을 도출한다.
...
### `extortion.component.l1.mandatory_negative.02`
...
### `extortion.component.l2.mandatory_negative.03`
...
### `extortion.component.l3.mandatory_negative.04`
...
### `extortion.component.l4.mandatory_negative.05`
