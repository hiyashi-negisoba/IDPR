"""Deterministic bootstrap reasoning for IDPR golden tests.

The first implementation is intentionally small and pure Python. It mirrors the
project contract for evidence gating and fraud golden cases while leaving the
Scallop runtime integration for the next implementation layer.
"""
