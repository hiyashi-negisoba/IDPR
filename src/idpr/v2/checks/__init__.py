"""The v2 Definition Layer Type checker: 6 independent semantic axes over a DefinitionRegistry.

Each axis module is independently callable (imports only registry/findings/expressions, never
another axis module) -- no axis assumes another has already run.
"""
...
def run_type_checks(registry: DefinitionRegistry) -> list[Finding]:
    """Never raises -- collects findings from all 6 axes, in axis order."""
